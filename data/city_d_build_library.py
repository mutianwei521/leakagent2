...
Persists to data/city_d/leak_cache.pkl and SKIPS already-computed entries, so it
...
Run repeatedly (or once in the background):  python data/city_d_build_library.py
"""
import os
import sys
import time
